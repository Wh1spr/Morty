...
public class C {
	...
	// Text Channels
	public static final String CHANNEL_INFO = "353925519126953984";
	public static final String CHANNEL_INTRODUCTION = "353931513424773121";
	public static final String CHANNEL_ANNOUNCEMENTS = "353932432149315594";
	public static final String CHANNEL_EVENTS = "353932447710445569";
	public static final String CHANNEL_FEEDBACK = "353970671857958913";
	public static final String CHANNEL_FIRST_GENERAL = "353931128362500098";
	public static final String CHANNEL_FIRST_QUESTIONS = "353931248995139596";
	public static final String CHANNEL_SECOND_GENERAL = "353923812439359488";
	public static final String CHANNEL_SECOND_QUESTIONS = "353931286710190080";
	public static final String CHANNEL_THIRD_GENERAL = "353931167768248331";
	public static final String CHANNEL_THIRD_QUESTIONS = "353931310420459522";
	public static final String CHANNEL_PROGRAMMING_GENERAL = "353932838581829636";
	public static final String CHANNEL_PROGRAMMING_HELP = "353932863063719947";
	...
	// Voice Channels
	// => ATM not necessary, so I'm not gonna put them here.
	
	// GUILD
	public static final String GUILD = "353923811994894337";
	...
	public static final String ROLE_MINOR_BAI = "353930739110379531";
	...
	public static final String SELF = "354268422827278336";
